...
class MyQueue(object):
    ...
    def push(self, x):
        ...
        :rtype: None
        """
        return self.stack_input.append(x)
    ...
    def empty(self):
        ...
        :rtype: bool
        """
        return  not(self.stack_input or self.stack_output)
...
class SolutionTestCase(unittest.TestCase):
    ...
    def test_example_2_leetcode(self):
        self.assertEqual(self.myQueue.pop(), 1)
    def test_example_3_leetcode(self):
        self.assertEqual(self.myQueue.empty(), False)
    def test_example_4_leetcode(self):
        self.assertEqual(self.myQueue.pop(), 2)
    def test_example_5_leetcode(self):
        self.assertEqual(self.myQueue.empty(), True)
